...
{
    public class CreateCleaningPlanRequestValidatorTest
    {
        private readonly CreateCleaningPlanRequestValidator _validator = new();
        ...
        {
            // Arrange
            var request = new CreateCleaningPlanRequest(title, 1, "Description");
        ...
        {
            // Arrange
            var request = new CreateCleaningPlanRequest("Title", 0, "Description");
